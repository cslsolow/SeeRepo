...
def _config_to_dict(obj: Any) -> dict:
    """Serialize config object to dict; supports Pydantic v1/v2 and dataclass."""
...
def save_traj(
    ...
    **kwargs,
    ...
    if agent is not None:
        ...
        data["info"]["config"] = {
            "agent": _config_to_dict(agent.config),
            "model": _config_to_dict(agent.model.config),
            "environment": _config_to_dict(agent.env.config),
